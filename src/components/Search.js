function Search() {
  return (
    <div className="mt-20 flex mx-10 justify-center">
      <div className="grid grid-cols-4 w-full max-w-2xl rounded-full border border-gray-200 cursor-pointer">
        <div className="btn-effect btn-shadow">
          <span className="text-left text-xs font-semibold">Location</span>
          <input
            type="text"
            placeholder="Where are you going ?"
            className="focus:outline-none overflow-ellipsis whitespace-nowrap overflow-hidden text-sm  placeholder-gray-500 bg-transparent"
          />
        </div>
